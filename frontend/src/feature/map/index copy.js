...
function Map() {
  ...
  const fetchGetMap = async () => {
    try {
      ...
      const response_1 = await mapApi.get_1();
      console.log("Get map -1 successfully: ", response_1.data);
      arr_new.push({
        width: 870,
        height: 500,
        longitude: response_1.data.features[0].center[0],
        latitude: response_1.data.features[0].center[1],
        zoom: 8,
      });
      const response_2=await mapApi.get_2();
      console.log("Get map Nguyen Thong successfully",response_2.data);
      arr_new.push({
        width: 870,
        height: 500,
        longitude: response_2.data.features[0].center[0],
        latitude: response_2.data.features[0].center[1],
        zoom: 8,
      });
       const response_3=await mapApi.get_3();
      console.log("Get map NThao dien successfully",response_3.data);
      arr_new.push({
        width: 870,
        height: 500,
        longitude: response_3.data.features[1].center[0],
        latitude: response_3.data.features[1].center[1],
        zoom: 8,
      });
           const response_4=await mapApi.get_4();
      console.log("Get map NThao dien successfully",response_4.data);
      arr_new.push({
        width: 870,
        height: 500,
        longitude: response_4.data.features[0].center[0],
        latitude: response_4.data.features[0].center[1],
        zoom: 8,
      });
      const response_5 = await mapApi.get_5();
      console.log("Get map NDTrinh successfully", response_5.data);
      arr_new.push({
        width: 870,
        height: 500,
        longitude: response_5.data.features[0].center[0],
        latitude: response_5.data.features[0].center[1],
        zoom: 8,
      });
      console.log("arr_new_updated", arr_new);
      setstate([...arr_new]);
    } catch (error) {
